...
<head>
    ...
    <link href="vendors/themify/css/themify-icons.css" rel="stylesheet" type="text/css"/>
    <!-- end of global css-->
    <!-- page level styles-->
...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 box animated fadeInUp">
            ...
            <form action="forgot_password.html" class="forgot_Form text-center" method="POST" id="forgot_password">
