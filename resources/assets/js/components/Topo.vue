        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu dropdown-messages table-striped nice_dropdown" tabindex="0" style="overflow: hidden; outline: none;">
                        <li class="dropdown-title">New Messages</li>
                        <li>
                            <a href="" class="message striped-col">
                                <img class="message-image img-circle" :src="avartar_perfil" alt="avatar-image">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown" aria-expanded="false">
                        <img :src="avartar_perfil" width="35" class="img-circle img-responsive pull-left" height="35" alt="User Image">
                        <div class="riot">
                            <div>
                                Addison
                                <span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img :src="avartar_perfil" class="img-circle" alt="User Image">
                            <p> Addison</p>
                        </li>
                        <!-- Menu Body -->
                        <li class="p-t-3">
...
<script>
    export default {
      props:['titulo','url','logo','avartar_perfil']
    }
</script>
